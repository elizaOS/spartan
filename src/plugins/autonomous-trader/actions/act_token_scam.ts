...
export default {
    ...
    handler: async (
        ...
        scamReport += `• Risk Score: ${rugCheckData.score || 'Unknown'}/100\n`
        ...
        const isLikelyScam = (rugCheckData.score || 0) >= 70 || rugCheckData.rugged || (rugCheckData.risks?.[0]?.level?.toLowerCase() === 'danger');
