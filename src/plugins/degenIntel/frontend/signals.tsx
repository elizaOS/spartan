                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-4 rounded-lg bg-background/50 border">
                            <div className="flex items-center justify-between mb-2">
                                <h3 className="text-xl font-bold">{signal.recommended_buy || signal.recommended_sell}</h3>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className={`text-2xl font-bold ${buy ? 'text-green-600' : 'text-muted-foreground'}`}>
                            {buy ? '✅' : '❌'}
                        </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className={`text-2xl font-bold ${sell ? 'text-red-600' : 'text-muted-foreground'}`}>
                            {sell ? '✅' : '❌'}
                        </div>
                        <p className="text-xs text-muted-foreground">
